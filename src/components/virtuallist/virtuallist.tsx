...
export const VirtualList: FunctionComponent < Partial < VirtualListProps >> = (
    ...
    return (
        <div
          className={
            className ? `${className} virtualList-box` : 'virtualList-box'
          }
          {...rest}
          style={{
        ...
        >
          <div
            ref={scrollRef}
            className={horizontal ? 'horizontal-box' : 'vertical-box'}
            style={{
              position: 'relative',
          ...
          >
            <ul
              className={
                horizontal
                  ? 'virtuallist-items horizontal-items'
                  : 'virtuallist-items vertical-items'
              }
              ref={itemsRef}
              style={{
                ...
                .map((data, index) => {
                  ...
                  return (
                    <li
                      ...
                      className={
                        dataIndex % 2 === 0
                          ? 'virtuallist-item even'
                          : 'virtuallist-item odd'
                      }
                      key={`${keyVal}`}
